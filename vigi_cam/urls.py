...
urlpatterns = [
    ...
    path('registrarAdminFirstTime/', views.registrarAdminFirstTime, name='registrarAdminFirstTime'),
      path('get_admin_data/<int:admin_id>/', views.get_admin_data, name='get_admin_data'),
    path('registrar_admin/', views.registrar_admin, name='registrar_admin'),
    path('editar_admin/<int:admin_id>/', views.editar_admin, name='editar_admin'),
    path('eliminar_admin/<int:admin_id>/', views.eliminar_admin, name='eliminar_admin'),
